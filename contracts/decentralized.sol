...
contract DecentralizedInsurance is AccessControl, ReentrancyGuard, Pausable {
    ...
    constructor() {
        ...
        // Add deployer as first assessor
        assessors.push(msg.sender);
        isAssessor[msg.sender] = true;
        
        minAssessorVotes = 1; // Minimum votes required for claim assessment
    }
    ...
    function createPool(
        ...
        if (_minimumContribution == 0 || _coverageLimit == 0) {
    ...
    function submitClaim(
        ...
        activePool(_poolId)
        validClaimAmount(_poolId, _amount)
    {
    ...
    /**
     * @dev Assess a claim (vote on approval/rejection)
     */
    function assessClaim(uint256 _claimId, bool _approve) 
        external 
        nonReentrant 
        whenNotPaused 
        validClaimId(_claimId)
        claimNotFinalized(_claimId)
    {
        ...
        // Auto-finalize if enough votes received
        _checkAndFinalizeClaim(_claimId);
    }


    /**
     * @dev Internal function to check and finalize claim based on votes
     */
    ...
    /**
     * @dev Set minimum assessor votes required
     */
    ...
    /**
     * @dev Check if address is pool member
     */
    ...
    /**
     * @dev Get member contribution for a pool
     */
    ...
    /**
     * @dev Check if assessor has voted on a claim
     */
    ...
    /**
     * @dev Prevents renouncing admin role for contract security
     */
